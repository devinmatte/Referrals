      ...
      <div id={"main"}>
        <div className={"inner"}>
          <header>
            ...
            <p>{"Sign up for any of these services using my referral code, I'll get something, but odds are so will you. (That's generally how referrals work)"}</p>
          </header>
          <section className={"tiles"}>
            ...
            <Product
              product={"Lyft"}
              description={"$5.00 in free ride credit for Lyft."}
              link={"https://www.lyft.com/invite/DEVINMATTE"}
            />
            <Product
              product={"Acorns"}
